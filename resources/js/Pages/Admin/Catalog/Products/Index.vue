<template>
  <app-layout title="Dashboard">
    ...
    <div class="flex justify-between items-center">
      <h1 class="text-3xl font-extrabold text-blue-gray-900">Products</h1>
      <div class="flex items-center">
        <Link :href="route('admin.dashboard')"
              as="button"
              type="button"
              class="flex items-center">
        <LogoutIcon class="w-5 h-5 text-gray-400" />
        导出
        </Link>
    ...
    <div class="mt-6">
      <div class="flex justify-between items-center">
        <div>
          <label for="price"
                 class="sr-only text-sm font-medium text-gray-700">Price</label>
      ...
      <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-0">
