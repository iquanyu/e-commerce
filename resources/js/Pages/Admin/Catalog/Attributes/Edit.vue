                ...
                <div class="col-span-2 sm:col-span-2">
                  ...
                  <div class="mt-1 rounded-md shadow-sm">
                    <select name="attribute-type"
                            ...
                            disabled
                            class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm  bg-gray-200">
              ...
              <div class="flex items-start">
                <div class="flex items-center h-5">
                  <input id="default_null_option"
                         ...
                         disabled
                         class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded bg-gray-200" />
                </div>
...
export default defineComponent({
  ...
  data () {
    return {
      form: this.$inertia.form({
        ...
        is_unique: this.attribute.is_unique,
        is_visible_on_front: this.attribute.is_visible_on_front,
        is_comparable: this.attribute.is_comparable,
        swatch_type: this.attribute.swatch_type,
        default_null_option: this.attribute.default_null_option,
  ...
  methods: {
    update () {
      this.form.put(`/admin/catalog/attributes/${this.attribute.id}`)
    },
    addListItem () {
